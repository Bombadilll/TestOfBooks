...
public class BookControll {
    ...
    public String findBook(Model model, @PathVariable Long id) {
        ...
        Book book= bookD.findBookById(id);
    ...
    public String findBooksByGenre(Model model, @PathVariable Long id) {
        ...
        Set<Book> books= bookD.findBookByGenre(id);
        model.addAttribute("bookList",books);
        return "index/bookslist";
    }
    ...
    public String findBooksByAuthor(Model model, @PathVariable Long id) {
        LOGGER.debug("get books by authorD");
        Set<Book> books= bookD.findBookByAuthor(id);
        model.addAttribute("bookList",books);
        return "index/bookslist";
    }
    ...
    public String createBookForm(Model model) {
        ...
        model.addAttribute("authorsList", authorD.findAll());
        model.addAttribute("genresList", genreD.findAll() );
    ...
    @RequestMapping(value = "/create-book", method = RequestMethod.POST)
       public String createBook(Model model, /*@ModelAttribute("newBook") Book newBook,*/
                           ...
                           //  @ModelAttribute("newAuthors") List<AuthorD> authors)
        ...
        LOGGER.debug("create book");
         ...
         bookD.save(book,pseudoOneStepConversion(auts),true,pseudoOneStepConversion(gens),true);
    ...
    public String editBook(Model model, @PathVariable Long id, /*@ModelAttribute("newBook") Book newBook,*/
        ...
        if ( "".equals(name)||name==null||price==0)
            return "redirect:/edit-book-form/"+id;
                ...
                Set<com.books.model.impl.Author> autList = new HashSet<com.books.model.impl.Author>() ;
            ...
            long[] gensLong = pseudoOneStepConversion(gens);
                ...
                return "redirect:/book/"+id;
                    ...
                    if (genList.equals(currentBook.getGenres())) {
                        bookD.save(book, autsLong, false, gensLong, false);
                    }else{
                        bookD.save(book, autsLong, false, gensLong, true);
                    }
                }else if(genList.equals(currentBook.getGenres())){
                    bookD.save(book, autsLong, true, gensLong, false);
                }else {
                    bookD.save(book, autsLong, true, gensLong, true);
                }
    ...
    public String deleteBook(Model model , @PathVariable long id) {
        ...
        bookD.remove(new Book.BookBuilder("removename").id(id).build());
